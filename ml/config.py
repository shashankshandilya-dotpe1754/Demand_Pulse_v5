...
ml/config.py
============
Central configuration for the DemandPulse ML forecasting engine.
...
LLM_PROVIDER   = os.environ.get("DEMANDPULSE_LLM_PROVIDER", "anthropic")
LLM_MODEL      = os.environ.get("DEMANDPULSE_LLM_MODEL", "")
LLM_MAX_TOKENS = 2048
