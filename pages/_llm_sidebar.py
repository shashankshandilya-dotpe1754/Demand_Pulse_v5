...
def llm_sidebar() -> dict:
    ...
    with st.sidebar:
        ...
        with st.expander("⚙️ Set one up", expanded=not llm["available"]):
            st.markdown("**Ollama — free, local, no API key**")
            st.code("# ollama.com/download\n"
                    "ollama pull qwen2.5:7b\n"
                    "ollama serve\n\n"
                    "export DEMANDPULSE_LLM_PROVIDER=ollama\n"
                    "export DEMANDPULSE_LLM_MODEL=qwen2.5:7b", language="bash")
            ...
            st.code('OPENAI_API_KEY = "sk-..."\n'
                    ...
                    'DEMANDPULSE_LLM_MODEL = "gpt-4o"', language="toml")
