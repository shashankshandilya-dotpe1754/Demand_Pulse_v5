...
pages/01_Restaurant_Impact.py) works unchanged.
  ...
  * force the ML engine   → DEMANDPULSE_ENGINE=ml     (errors instead of falling back)
  * force the rule engine → DEMANDPULSE_ENGINE=rules
...
def _engine_pref() -> str:
    return os.environ.get("DEMANDPULSE_ENGINE", "auto").lower()
